...
class SettingClass(private val context: Context) {
    ...
    var appTheme: ThemeUtils.Theme
        ...
        get() = ThemeUtils.Theme.valueOf(getString(NORMAL_SETTING, THEME_APPLICATION, ThemeUtils.Theme.System.toString()))
    ...
    fun getStringSet(
        preferenceName: String, key: String, defaultValue: Set<String>, mode: Int = Context.MODE_PRIVATE
    ): Set<String> {
        val preference = context.getSharedPreferences(preferenceName, mode)
        return preference.getStringSet(key, defaultValue) ?: defaultValue
    }

    fun getStringSetOrNull(
        preferenceName: String, key: String, defaultValue: Set<String>? = null, mode: Int = Context.MODE_PRIVATE
    ): Set<String>? {
        val preference = context.getSharedPreferences(preferenceName, mode)
    ...
    fun getStringSet(key: String, defaultValue: Set<String>): Set<String> {
        return PreferenceManager.getDefaultSharedPreferences(context).getStringSet(key, defaultValue) ?: defaultValue
    }
    ...
    fun getAllPreferenceItem(preferenceName: String, mode: Int = Context.MODE_PRIVATE): Map<String, *> {
        return context.getSharedPreferences(preferenceName, mode).all
    }

    fun <T> getAllPreferenceSpecificItem(preferenceName: String, mode: Int = Context.MODE_PRIVATE): Map<String, T> {
        return getAllPreferenceItem(preferenceName, mode).toList().filterIsInstance<Pair<String, T>>().toMap()
    }
    ...
    fun deletePreferenceItem(preferenceName: String, key: String, mode: Int = Context.MODE_PRIVATE) {
        val preference = context.getSharedPreferences(preferenceName, mode)
    ...
    fun setListener(preferenceName: String, listener: SharedPreferences.OnSharedPreferenceChangeListener, mode: Int = Context.MODE_PRIVATE) {
        val preference = context.getSharedPreferences(preferenceName, mode)
